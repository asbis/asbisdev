  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.base }]}>
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={[styles.headerLabel, { color: theme.textFaint }]}>MOTIVASJONSVEGG</Text>
          <SectionTitle size={26}>Ditt galleri.</SectionTitle>
        </View>
      </View>
              ...
              <View 
                ...
                style={[
                  ...
                  { 
                    ...
                    width: isFullWidth ? '100%' : (width - 50) / 2,
                    aspectRatio: isFullWidth ? 1 / 1.2 : 1 / 1.15,
                  }
                ]}
              >
                <LinearGradient
                  colors={[theme[p.tone] + '66', theme[p.tone] + '22', 'transparent']}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 1 }}
                ...
                <View style={styles.postContent}>
                  ...
                  <Text style={[
                    styles.postQuote, 
                    { color: theme.text, fontSize: isFullWidth ? 24 : 16 }
                  ]}>
                    {p.quote}
                  </Text>
