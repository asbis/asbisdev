...
const BASE = "http://localhost:3000/oppdrag/2026-107028-antidoping-app";
const OUT =
  process.argv[2] ||
...
const DOCS = [
  ...
  { slug: "vart-utkast/BILAG-2-SAMLET", out: "02 Bilag 2 — Konsulentens spesifikasjon (samlet).pdf" },
  { slug: "vart-utkast/bilag2-1-app-losning", out: "02.1 Bilag 2 — App-løsningen og dens kvalitet.pdf" },
  ...
  { slug: "vart-utkast/bilag2-4-service-support", out: "02.4 Bilag 2 — Service, support og vedlikehold.pdf" },
