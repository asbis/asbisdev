...
const DIR = "/Users/asbis/code/asbisdev/oppdrag/aktive/2026-111353-met-geoweb-frontend";
const OUT = join(DIR, "til-innsending", "autogenerert");
mkdirSync(OUT, { recursive: true });

const DOCS = [
  { src: "vart-utkast/tilbudsbrev.md", out: "Letter of Tender — Asbjørn Rørvik.pdf" },
  { src: "vart-utkast/cv-asbjorn.md", out: "CV — Asbjørn Rørvik.pdf" },
  { src: "vart-utkast/referanser-innsending.md", out: "Reference Assignments — Asbjørn Rørvik.pdf" },
  { src: "vart-utkast/bilag2-response.md", out: "Appendix 2 — Consultant specification (readable).pdf" },
];
